            ...
            <form onSubmit={postData}>
              <div className="row">
                <div className="col-md-6 mb-3">
                  ...
                  <input type="text" name="name" onChange={getInputData} className='form-control' placeholder='Name' value={data.name} />
              ...
              <div className="row">
                <div className="col-md-6 mb-3">
                  ...
                  <input type="number" name="rating" onChange={getInputData} className='form-control' placeholder='Rating' value={data.rating} />
              ...
              <div className="mb-3">
                ...
                <textarea name="message" rows="5" className='form-control' placeholder='Message....' value={data.message} onChange={getInputData}></textarea>
