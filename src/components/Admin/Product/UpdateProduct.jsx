            ...
            <form onSubmit={postData}>
              ...
              <div className="row">
                <div className="col-md-3 col-sm-6 col-12">
                  ...
                  <select name="maincategory" onChange={getInputData} className='form-select mb-3' value={data.maincategory}>
                    {
                ...
                <div className="col-md-3 col-sm-6 col-12">
                  ...
                  <select name="subcategory" onChange={getInputData} className='form-select mb-3' value={data.subcategory}>
                    {
                ...
                <div className="col-md-3 col-sm-6 col-12">
                  ...
                  <select name="brand" onChange={getInputData} className='form-select mb-3' value={data.brand}>
                    {
                ...
                <div className="col-md-3 col-sm-6 col-12">
                  ...
                  <select name="stock" onChange={getInputData} className='form-select mb-3' value={data.stock}>
              ...
              <div className="row">
                <div className="col-md-6 mb-3">
                  ...
                  <input type="text" name="color" onChange={getInputData} className='form-control' placeholder='Color' value={data.color} />
                  {show ? <p className='text-danger fs-6 text-capitalize  '>{errorMessages.color}</p> : ""}
                </div>
                <div className="col-md-6 mb-3">
                  <label>Size<span className='text-danger'>*</span></label>
                  <input type="text" name="size" onChange={getInputData} className='form-control' placeholder='Size' value={data.size} />
              ...
              <div className="row">
                <div className="col-md-6 mb-3">
                  ...
                  <input type="text" name="baseprice" onChange={getInputData} className='form-control' placeholder='Baseprice' value={data.baseprice} />
                ...
                <div className="col-md-6 mb-3">
                  ...
                  <input type="text" name="discount" onChange={getInputData} className='form-control' placeholder='Discount' value={data.discount} />
